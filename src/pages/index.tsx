      ...
      <div className="mx-6 my-8">
        ...
        <div>
          ...
          <div className="text-base text-gray-900 mb-3 font-light">
            ...
            “no-fault” states, whereby policyholders claim losses from their own
            insurance provider – regardless of which driver was at fault.
          </div>
          <div className="text-base text-gray-900 mb-3 font-light">
            The best auto insurance companies in each state provide liability,
            comprehensive, collision, PIP, and uninsured & underinsured motorist
            coverage, plus a range of paid add-ons.
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6">
            ...
            <li className="text-xl md:text-base font-light text-gray-900">
              ...
              well informed. For a general assessment of company reputation and
              customer satisfaction , you can also check how the company is
            ...
            <li className="text-xl md:text-base font-light text-gray-900">
              ...
              insurance companies like National Family may have a driver reward
              program so it's worth looking into.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="text-xl md:text-base   font-light text-gray-900 mb-3">
            ...
            your vehicle. Within a few seconds you’ll be redirected to a screen
            with your quote or, in some cases, you’ll be emailed the quote. You
            can then choose whether or not to go ahead and complete your
            application.
          </div>
          <div className="text-xl md:text-base font-light text-gray-900 mb-3">
            The key to getting the best rate for your needs is to compare quotes
            and policies from multiple providers. The more companies you
            compare, the more time it will require—but the more money it may end
