...
enum FileFieldsEnum {
  ...
  childMdx___frontmatter___logo___sourceInstanceName = 'childMdx.frontmatter.logo.sourceInstanceName',
  childMdx___frontmatter___logo___absolutePath = 'childMdx.frontmatter.logo.absolutePath',
  childMdx___frontmatter___logo___relativePath = 'childMdx.frontmatter.logo.relativePath',
  childMdx___frontmatter___logo___extension = 'childMdx.frontmatter.logo.extension',
  childMdx___frontmatter___logo___size = 'childMdx.frontmatter.logo.size',
  childMdx___frontmatter___logo___prettySize = 'childMdx.frontmatter.logo.prettySize',
  childMdx___frontmatter___logo___modifiedTime = 'childMdx.frontmatter.logo.modifiedTime',
  childMdx___frontmatter___logo___accessTime = 'childMdx.frontmatter.logo.accessTime',
  childMdx___frontmatter___logo___changeTime = 'childMdx.frontmatter.logo.changeTime',
  childMdx___frontmatter___logo___birthTime = 'childMdx.frontmatter.logo.birthTime',
  childMdx___frontmatter___logo___root = 'childMdx.frontmatter.logo.root',
  childMdx___frontmatter___logo___dir = 'childMdx.frontmatter.logo.dir',
  childMdx___frontmatter___logo___base = 'childMdx.frontmatter.logo.base',
  childMdx___frontmatter___logo___ext = 'childMdx.frontmatter.logo.ext',
  childMdx___frontmatter___logo___name = 'childMdx.frontmatter.logo.name',
  childMdx___frontmatter___logo___relativeDirectory = 'childMdx.frontmatter.logo.relativeDirectory',
  childMdx___frontmatter___logo___dev = 'childMdx.frontmatter.logo.dev',
  childMdx___frontmatter___logo___mode = 'childMdx.frontmatter.logo.mode',
  childMdx___frontmatter___logo___nlink = 'childMdx.frontmatter.logo.nlink',
  childMdx___frontmatter___logo___uid = 'childMdx.frontmatter.logo.uid',
  childMdx___frontmatter___logo___gid = 'childMdx.frontmatter.logo.gid',
  childMdx___frontmatter___logo___rdev = 'childMdx.frontmatter.logo.rdev',
  childMdx___frontmatter___logo___ino = 'childMdx.frontmatter.logo.ino',
  childMdx___frontmatter___logo___atimeMs = 'childMdx.frontmatter.logo.atimeMs',
  childMdx___frontmatter___logo___mtimeMs = 'childMdx.frontmatter.logo.mtimeMs',
  childMdx___frontmatter___logo___ctimeMs = 'childMdx.frontmatter.logo.ctimeMs',
  childMdx___frontmatter___logo___atime = 'childMdx.frontmatter.logo.atime',
  childMdx___frontmatter___logo___mtime = 'childMdx.frontmatter.logo.mtime',
  childMdx___frontmatter___logo___ctime = 'childMdx.frontmatter.logo.ctime',
  childMdx___frontmatter___logo___birthtime = 'childMdx.frontmatter.logo.birthtime',
  childMdx___frontmatter___logo___birthtimeMs = 'childMdx.frontmatter.logo.birthtimeMs',
  childMdx___frontmatter___logo___blksize = 'childMdx.frontmatter.logo.blksize',
  childMdx___frontmatter___logo___blocks = 'childMdx.frontmatter.logo.blocks',
...
enum MdxFieldsEnum {
  ...
  frontmatter___logo___sourceInstanceName = 'frontmatter.logo.sourceInstanceName',
  frontmatter___logo___absolutePath = 'frontmatter.logo.absolutePath',
  frontmatter___logo___relativePath = 'frontmatter.logo.relativePath',
  frontmatter___logo___extension = 'frontmatter.logo.extension',
  frontmatter___logo___size = 'frontmatter.logo.size',
  frontmatter___logo___prettySize = 'frontmatter.logo.prettySize',
  frontmatter___logo___modifiedTime = 'frontmatter.logo.modifiedTime',
  frontmatter___logo___accessTime = 'frontmatter.logo.accessTime',
  frontmatter___logo___changeTime = 'frontmatter.logo.changeTime',
  frontmatter___logo___birthTime = 'frontmatter.logo.birthTime',
  frontmatter___logo___root = 'frontmatter.logo.root',
  frontmatter___logo___dir = 'frontmatter.logo.dir',
  frontmatter___logo___base = 'frontmatter.logo.base',
  frontmatter___logo___ext = 'frontmatter.logo.ext',
  frontmatter___logo___name = 'frontmatter.logo.name',
  frontmatter___logo___relativeDirectory = 'frontmatter.logo.relativeDirectory',
  frontmatter___logo___dev = 'frontmatter.logo.dev',
  frontmatter___logo___mode = 'frontmatter.logo.mode',
  frontmatter___logo___nlink = 'frontmatter.logo.nlink',
  frontmatter___logo___uid = 'frontmatter.logo.uid',
  frontmatter___logo___gid = 'frontmatter.logo.gid',
  frontmatter___logo___rdev = 'frontmatter.logo.rdev',
  frontmatter___logo___ino = 'frontmatter.logo.ino',
  frontmatter___logo___atimeMs = 'frontmatter.logo.atimeMs',
  frontmatter___logo___mtimeMs = 'frontmatter.logo.mtimeMs',
  frontmatter___logo___ctimeMs = 'frontmatter.logo.ctimeMs',
  frontmatter___logo___atime = 'frontmatter.logo.atime',
  frontmatter___logo___mtime = 'frontmatter.logo.mtime',
  frontmatter___logo___ctime = 'frontmatter.logo.ctime',
  frontmatter___logo___birthtime = 'frontmatter.logo.birthtime',
  frontmatter___logo___birthtimeMs = 'frontmatter.logo.birthtimeMs',
  frontmatter___logo___blksize = 'frontmatter.logo.blksize',
  frontmatter___logo___blocks = 'frontmatter.logo.blocks',
  frontmatter___logo___publicURL = 'frontmatter.logo.publicURL',
  frontmatter___logo___childImageSharp___id = 'frontmatter.logo.childImageSharp.id',
  frontmatter___logo___childImageSharp___children = 'frontmatter.logo.childImageSharp.children',
  frontmatter___logo___id = 'frontmatter.logo.id',
  frontmatter___logo___parent___id = 'frontmatter.logo.parent.id',
  frontmatter___logo___parent___children = 'frontmatter.logo.parent.children',
  frontmatter___logo___children = 'frontmatter.logo.children',
  frontmatter___logo___children___id = 'frontmatter.logo.children.id',
  frontmatter___logo___children___children = 'frontmatter.logo.children.children',
  frontmatter___logo___internal___content = 'frontmatter.logo.internal.content',
  frontmatter___logo___internal___contentDigest = 'frontmatter.logo.internal.contentDigest',
  frontmatter___logo___internal___description = 'frontmatter.logo.internal.description',
  frontmatter___logo___internal___fieldOwners = 'frontmatter.logo.internal.fieldOwners',
  frontmatter___logo___internal___ignoreType = 'frontmatter.logo.internal.ignoreType',
  frontmatter___logo___internal___mediaType = 'frontmatter.logo.internal.mediaType',
  frontmatter___logo___internal___owner = 'frontmatter.logo.internal.owner',
  frontmatter___logo___internal___type = 'frontmatter.logo.internal.type',
  frontmatter___logo___childMdx___rawBody = 'frontmatter.logo.childMdx.rawBody',
  frontmatter___logo___childMdx___fileAbsolutePath = 'frontmatter.logo.childMdx.fileAbsolutePath',
  frontmatter___logo___childMdx___slug = 'frontmatter.logo.childMdx.slug',
  frontmatter___logo___childMdx___body = 'frontmatter.logo.childMdx.body',
  frontmatter___logo___childMdx___excerpt = 'frontmatter.logo.childMdx.excerpt',
  frontmatter___logo___childMdx___headings = 'frontmatter.logo.childMdx.headings',
  frontmatter___logo___childMdx___html = 'frontmatter.logo.childMdx.html',
  frontmatter___logo___childMdx___mdxAST = 'frontmatter.logo.childMdx.mdxAST',
  frontmatter___logo___childMdx___tableOfContents = 'frontmatter.logo.childMdx.tableOfContents',
...
type ReviewsQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<(
      Pick<Mdx, 'id' | 'excerpt' | 'body'>
      & { readonly frontmatter: Maybe<(
        Pick<MdxFrontmatter, 'date' | 'author' | 'slug' | 'title'>
        & { readonly logo: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }
      )> }
    )> } };
